...
$config['admin_email']                = "admin@pepproject.co"; // Admin Email, admin@example.com
...
$config['manual_activation'] = FALSE; // Send Email using the builtin CI email class, if false it will return the code and the identity
$config['email_config'] = array(
	'mailtype' => 'html',
    'protocol' => 'smtp',
    'smtp_host' => 'pepproject.co',
    'smtp_user' => 'admin@pepproject.co',
    'smtp_pass' => 'Wisdom99@@',
    'charset' => 'iso-8859-1',
    'smtp_port' => '465',
    'wordwrap' => TRUE,
