...
class Xpep_buyback_history extends CI_Controller {

    public function __construct()
    {
        parent::__construct();
        $this->load->model('user/xpep_buyback_history_model','transaction');
    ...
    public function index()
    {
        ...
        $this->load->view('user/xpep_buyback_history_view');
