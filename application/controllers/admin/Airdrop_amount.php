...
class Airdrop_amount extends CI_Controller {
	...
	public function __construct()
	{
        ...
        $this->lang->load('auth');
		$this->load->model('admin/Airdrop_amount_model','person');
	}
	...
	public function index()
	{
        ...
        $this->load->view('admin/airdrop_amount_view');
	...
	public function ajax_add()
	{
        ...
        if($this->person->isDuplicate2($this->input->post('type'))){
            $this->session->set_flashdata('flash_message', 'Rate already exist');
            redirect(site_url().'/admin/airdrop_amount');
        }
