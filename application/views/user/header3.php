...
<div id="wrapper">
            ...
            <div id="navbar-menu">
                <ul class="nav navbar-nav navbar-right">
                    <li style="padding-right: 10px;">
                        <h4 class="text-danger">PEP</h4>
                        <h5>$0.01</h5>
                    </li>
                    <li style="padding-right: 10px;">
                        <h4 class="text-danger">XPEP</h4>
                        <h5>$1</h5>
                    </li>
                    <li style="padding-right: 10px;">
                        <h4 class="text-danger">STEEM</h4>
                        <h5>$<b id="coin26"></b></h5>
                    </li>
                    <li class="dropdown">
        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li>
                        <a href="#subPages2" data-toggle="collapse" class="collapsed"><i class="fa fa-shopping-bag"></i> <span>Buy &amp; Sell XPEP</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
                        <div id="subPages2" class="collapse">
                            <ul class="nav">
                                <li><a href="<?php echo site_url('frontend/fund_xpep') ?>" class="">Buy XPEP</a></li>
                                <li><a href="<?php echo site_url('frontend/sell_xpep') ?>" class="">XPEP BuyBack</a></li>
                            </ul>
                        </div>
                    </li>
    ...
    <!-- END LEFT SIDEBAR -->
    <!-- MAIN -->
    <div class="main" style="background-color: darkgoldenrod">
        <!-- MAIN CONTENT -->
