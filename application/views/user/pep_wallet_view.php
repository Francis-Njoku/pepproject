    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            <h3 class="panel-title">PEPCOIN (PEP)</h3>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="table-responsive">
                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th style="background-color: red; color: white"  colspan="6"><h4 align="center"><b>PEP Transaction history</b></h4></th>
                        </tr>
                        <tr>
                            <th>Currency</th>
                            <th>Type</th>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Deposit PEPCOIN from XCoinlive</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <h4 style="color: goldenrod;">Deposit PEPCOIN from XCoinlive</h4>
                        </div>
                        <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-style-5">
                        <fieldset>
                            <form name="Payment" method="post" action="<?php echo site_url().'/frontend/fund_wallet/save_order2' ?>" >
                                ...
                                <input placeholder="value" type="hidden" name="destination" value="PEP" required/>
    ...
    <div id="myModal2" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Deposit PEPCOIN from GoPEPcash </h4>
                </div>
                <div class="modal-body">
                    <?php
                    $bitcoin_value = 1;
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <h4 style="color: goldenrod;">Deposit PEPCOIN from GoPEPcash</h4>
    ...
    <div id="myModal3" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Deposit PEPCOIN FROM WAVES Wallet</h4>
                </div>
                <div class="modal-body">
                    <?php
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                             <h5>Deposit PEPCOIN from WAVES</h5>
                        </div>
                        <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-style-5">
                        <fieldset>
                            ...
                            <form name="Payment" method="post" action="<?php echo site_url().'/frontend/withdraw/save_request' ?>" >
                                ...
                                if ($waves_add != '')
                                {
                                    echo '<p align="center"> PEPCOIN will be sent to this address: <b>'.$waves_add.'</b></p>';
                                }
                                else
                                {
