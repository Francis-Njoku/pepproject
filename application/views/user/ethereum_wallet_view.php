    ...
    <div class="container-fluid">
        <div class="row">
            ...
            foreach($retrieve_user as $user) {
                ...
                $ethereum_add = $user['ethereum_address'];
            }
    ...
    <div class="panel panel-headline">
        <div class="panel-heading">
            <h3 class="panel-title">Ethereum</h3>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="metric">
                        ...
                        <p>
                            <span class="number"><?php $ethereum_balance = $total_credit_ethereum - $total_debit_ethereum; echo number_format($ethereum_balance, 4); ?></span>
                            <span class="title">Ethereum Balance</span>
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="metric">
                        <span class="icon"><i class="fa fa-money"></i></span>
                        <p>
                            <span class="number"><?php if($total_credit_ethereum == ''){echo '0.0000';} else echo number_format($total_credit_ethereum, 4); ?></span>
                            <span class="title">Total Ethereum credit</span>
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="metric">
                        <span class="icon"><i class="fa fa-money"></i></span>
                        <p>
                            <span class="number"><?php if($total_debit_ethereum == ''){echo '0.0000';} else echo number_format($total_debit_ethereum, 4); ?></span>
                            <span class="title">Total Ethereum debit</span>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="table-responsive">
                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th style="background-color: red; color: white"  colspan="6"><h4 align="center"><b>Ethereum Transaction history</b></h4></th>
                        </tr>
                        <tr>
                            <th>Currency</th>
                            <th>Type</th>
                        ...
                        <?php
                        foreach ($ethereum_wallet as $details) {
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Deposit Ethereum from Ethereum Wallet</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <p align="center">Ethereum address to deposit: <b>0xbc0ae12b397e6be23e190a1f0da974103d711788</b></p>
                        </div>
                    </div>
                    ...
                    <div class="form-style-5">
                        <fieldset>
                            <form name="Payment" method="post" action="<?php echo site_url().'/frontend/fund_wallet/save_order3' ?>" >
                                ...
                                <input placeholder="value" type="hidden" name="destination" value="Ethereum" required/>
    ...
    <div id="myModal4" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Withdraw to Ethereum Wallet</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-style-5">
                        <fieldset>
                            ...
                            <form name="Payment" method="post" action="<?php echo site_url().'/frontend/withdraw/save_request' ?>" >
                                ...
                                if ($ethereum_add != '')
                                {
                                    echo '<p align="center"> Ethereum will be sent to this address: <b>'.$ethereum_add.'</b></p>';
                                }
                                else
                                {
                                    echo '<a href="'.site_url('frontend/user_details').'"><b style="color: red;"> You don\'t have an Ethereum wallet address on file, </b><b style="color: green;">click here to input your Ethereum address</b></a>';
                                }
                                ?>
