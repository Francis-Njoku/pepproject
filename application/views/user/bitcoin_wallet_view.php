    ...
    <div class="container-fluid">
        <div class="row">
            ...
            foreach($retrieve_user as $user) {
                ...
                $bitcoin_add = $user['bitcoin_address'];
            }
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="metric">
                        ...
                        <p>
                            <span class="number"><?php $bitcoin_balance = $total_credit_bitcoin - $total_debit_bitcoin; echo number_format($bitcoin_balance, 4); ?></span>
                ...
                <div class="col-md-4">
                    <div class="metric">
                        <span class="icon"><i class="fa fa-money"></i></span>
                        <p>
                            <span class="number"><?php if($total_credit_bitcoin == ''){echo '0.0000';} else echo number_format($total_credit_bitcoin, 4); ?></span>
                            <span class="title">Total Bitcoin credit</span>
                        </p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="metric">
                        <span class="icon"><i class="fa fa-money"></i></span>
                        <p>
                            <span class="number"><?php if($total_debit_bitcoin == ''){echo '0.0000';} else echo number_format($total_debit_bitcoin, 4); ?></span>
                            <span class="title">Total Bitcoin debit</span>
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="table-responsive">
                    <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                        <tr>
                            <th style="background-color: red; color: white"  colspan="6"><h4 align="center"><b>Bitcoin Transaction history</b></h4></th>
                        </tr>
                        <tr>
                            <th>Currency</th>
                            <th>Type</th>
                        ...
                        <?php
                        foreach ($bitcoin_wallet as $details) {
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Deposit Bitcoin from Bitcoin Wallet</h4>
                </div>
                <div class="modal-body">
                    <?php
                    foreach($currency_bitcoin as $currency)
                    {
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 col-sm-12">
                            <p align="center">Bitcoin address to deposit: <b>15yHJ6QQfNWyLLBNLKyWLvN2prxv1N4ahy</b></p>
                        </div>
                    </div>
                    ...
                    <div class="form-style-5">
                        <fieldset>
                            <form name="Payment" method="post" action="<?php echo site_url().'/frontend/fund_wallet/save_order3' ?>" >
                                ...
                                <input placeholder="value" type="hidden" name="destination" value="Bitcoin" required/>
    ...
    <div id="myModal4" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Withdraw to Bitcoin Wallet</h4>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-style-5">
                        <fieldset>
                            ...
                            <form name="Payment" method="post" action="<?php echo site_url().'/frontend/withdraw/save_request' ?>" >
                                ...
                                if ($bitcoin_add != '')
                                {
                                    echo '<p align="center"> Bitcoin will be sent to this address: <b>'.$bitcoin_add.'</b></p>';
                                }
                                else
                                {
                                    echo '<a href="'.site_url('frontend/user_details').'"><b style="color: red;"> You don\'t have an Bitcoin wallet address on file, </b><b style="color: green;">click here to input your Bitcoin address</b></a>';
                                }
                                ?>
