            ...
            <div class="table-responsive">
                <table id="table" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th style="width: 10px; font-size: 12px;">Amount</th>
        ...
        foreach ($blog_list->result() as $blog) {
            ...
            <tr <?php if($blog->status == 2) echo 'style="background-color: lightblue"'; ?>>
                ...
                <td>
                    ...
                    if ($blog->status == 0)
                    {
                        echo site_url().'/admin/admin_approve_xpep/credit';
                    }
                    elseif ($blog->status == 2)
                    {
                        echo site_url().'/admin/admin_approve_xpep/#';
                    }
                    ...
                    if ($blog->status == 0)
                    {
                        echo site_url().'/admin/admin_approve_xpep/cancel';
                    }
                    elseif ($blog->status == 1)
                    {
                        echo site_url().'/admin/admin_approve_xpep/#';
